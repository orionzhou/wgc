...
x = load(fi)
h1 = sequence(rle(as.character(tth$comp))$lengths)
names(h1) = tth %>% distinct(comp) %>% pull(comp)
kable(tt, format = 'markdown', longtable = F, booktabs = T,
  colnames = c('', h2),
...
kable(tv, format = 'markdown', booktabs = T,
